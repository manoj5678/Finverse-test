...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('cases');

// This file contains the logic of every route in Forest Admin for the collection cases:
...
// Create a Case
router.post('/cases', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Case
router.put('/cases/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Case
router.delete('/cases/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Cases
router.get('/cases', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Cases
router.get('/cases/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Case
router.get('/cases/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/cases.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
router.delete('/cases', permissionMiddlewareCreator.delete(), (request, response, next) => {
