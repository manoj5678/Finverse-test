...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('auditLog');

// This file contains the logic of every route in Forest Admin for the collection auditLog:
...
// Create a Audit Log
router.post('/auditLog', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Audit Log
router.put('/auditLog/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Audit Log
router.delete('/auditLog/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/auditLog', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Audit Logs
router.get('/auditLog/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Audit Log
router.get('/auditLog/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Audit Logs
router.get('/auditLog.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Audit Logs
router.delete('/auditLog', permissionMiddlewareCreator.delete(), (request, response, next) => {
