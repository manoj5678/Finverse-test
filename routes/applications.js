...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('applications');
...
router.post('/applications', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/applications/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/applications/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/applications', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/applications/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Application
router.get('/applications/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/applications.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
router.delete('/applications', permissionMiddlewareCreator.delete(), (request, response, next) => {
