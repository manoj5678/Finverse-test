...
const { caseLinks } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('caseLinks');

// This file contains the logic of every route in Forest Admin for the collection caseLinks:
...
// Create a Case Link
router.post('/caseLinks', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Case Link
router.put('/caseLinks/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Case Link
router.delete('/caseLinks/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Case Links
router.get('/caseLinks', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Case Links
router.get('/caseLinks/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Case Link
router.get('/caseLinks/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Case Links
router.get('/caseLinks.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Case Links
router.delete('/caseLinks', permissionMiddlewareCreator.delete(), (request, response, next) => {
