...
const { amlAlerts } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('amlAlerts');

// This file contains the logic of every route in Forest Admin for the collection amlAlerts:
...
// Create a Aml Alert
router.post('/amlAlerts', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Aml Alert
router.put('/amlAlerts/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Aml Alert
router.delete('/amlAlerts/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Aml Alerts
router.get('/amlAlerts', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Aml Alerts
router.get('/amlAlerts/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Aml Alert
router.get('/amlAlerts/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Aml Alerts
router.get('/amlAlerts.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Aml Alerts
router.delete('/amlAlerts', permissionMiddlewareCreator.delete(), (request, response, next) => {
