...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('alerts');

// This file contains the logic of every route in Forest Admin for the collection alerts:
...
// Create a Alert
router.post('/alerts', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Alert
router.put('/alerts/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Alert
router.delete('/alerts/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/alerts', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Alerts
router.get('/alerts/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Alert
router.get('/alerts/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/alerts.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Alerts
router.delete('/alerts', permissionMiddlewareCreator.delete(), (request, response, next) => {
