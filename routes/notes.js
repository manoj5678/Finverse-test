...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('notes');

// This file contains the logic of every route in Forest Admin for the collection notes:
...
// Update a Note
router.put('/notes/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Note
router.delete('/notes/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Notes
router.get('/notes', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Notes
router.get('/notes/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Note
router.get('/notes/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/notes.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
router.delete('/notes', permissionMiddlewareCreator.delete(), (request, response, next) => {
